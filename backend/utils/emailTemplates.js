...
<body style="${baseStyles} background-color: ${bgColor}; padding: 20px;">
    <div style="${containerStyles}">
        ...
        <div style="${contentStyles}">
            ...
            <p>At Adbuthverse, we take your data privacy seriously. By removing these assets after delivery, we ensure that your personal media is not stored longer than necessary for the fulfillment of your order.</p>
            
            <p>We hope you are enjoying your digital assets! If you need further assistance, our support team is always here to help.</p>
            
            <p style="margin-top: 30px;">Warm regards,<br>The Adbuthverse Team</p>
        </div>
...
<body style="${baseStyles} background-color: ${bgColor}; padding: 20px;">
    <div style="${containerStyles}">
        ...
        <div style="${contentStyles}">
            ...
            <p style="margin-top: 30px;">Best regards,<br>The Adbuthverse Team</p>
        </div>
