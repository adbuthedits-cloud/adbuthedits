        ...
        <div className="bg-white min-h-screen font-sans">
            ...
            <div className="max-w-4xl mx-auto px-6 py-20 text-gray-800">
                ...
                <div className="space-y-6 leading-relaxed">
                    <p>Welcome to Adbuth Verse. By accessing our website and purchasing our services, you agree to these terms and conditions.</p>
                    ...
                    <p>All content on this website is the property of Adbuth Verse.</p>
