...
export default function ShopSidebar({ filters, onFilterChange, masterData, maxPrice, isMobile = false }) {
    ...
    return (
        <aside className={`${isMobile ? 'w-full h-full' : 'w-64 sticky top-0 h-screen border-r'} flex-shrink-0 overflow-y-auto custom-scroll bg-white border-gray-100 flex flex-col`}>
            {/* Header */}
