        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-12">
            ...
            <div className="mb-6">
                ...
                <textarea
                    ...
                    className="w-full h-32 p-4 bg-gray-50 !text-black placeholder:text-gray-500 border border-transparent rounded-xl focus:bg-white focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all outline-none resize-none"
