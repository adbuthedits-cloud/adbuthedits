...
function EditCoupon() {
    ...
    const fetchCoupon = async () => {
        try {
            ...
            setInitialFormData(fetchedForm);
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`${apiUrl}/api/admin/coupons/${id}`, dataToSubmit, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    return (
        <div className="w-full max-w-4xl mx-auto pb-20">
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-white tracking-tight">Edit Coupon</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-8 bg-[#1E1628] rounded-3xl p-8 border border-[#2d1b4e] shadow-2xl">
                ...
                <div className="flex justify-end gap-3 mt-10 pt-6 border-t border-[#2d1b4e]">
                    ...
                    >
                        {saving ? "Updating..." : "Update Promotion"}
                    </button>
                </div>
            </form>
        </div>
...
export default withPermission(EditCoupon, "marketing");
